...
#include "gazebo_ros_fog_camera.h"
...
GZ_REGISTER_SENSOR_PLUGIN(GazeboRosFogCamera)

////////////////////////////////////////////////////////////////////////////////
// Constructor
GazeboRosFogCamera::GazeboRosFogCamera()
{
}
...
GazeboRosFogCamera::~GazeboRosFogCamera()
{
  ROS_DEBUG_STREAM_NAMED("fog_camera","Unloaded");
}

void GazeboRosFogCamera::Load(sensors::SensorPtr _parent, sdf::ElementPtr _sdf)
{
  // Make sure the ROS node for Gazebo has already been initialized
  if (!ros::isInitialized())
  {
    ROS_FATAL_STREAM_NAMED("fog_camera", "A ROS node for Gazebo has not been initialized, unable to load plugin. "
...
void GazeboRosFogCamera::OnNewFrame(const unsigned char *_image,
    ...
    const std::string &_format)
{
  ...
  else
  {
    if ((*this->image_connect_count_) > 0)
    {
      ...
      {
          ROS_WARN_NAMED("fog_camera", "Negative sensor update time difference detected.");
