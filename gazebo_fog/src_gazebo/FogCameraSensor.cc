...
#include "FogCameraSensorPrivate.hh"
#include "FogCameraSensor.hh"

using namespace gazebo;
using namespace sensors;

GZ_REGISTER_STATIC_SENSOR("fog_camera", FogCameraSensor)

//////////////////////////////////////////////////
FogCameraSensor::FogCameraSensor()
: Sensor(sensors::IMAGE),
  dataPtr(new FogCameraSensorPrivate)
{
  this->connections.push_back(
      event::Events::ConnectRender(
        std::bind(&FogCameraSensor::Render, this)));
}
...
//////////////////////////////////////////////////
void FogCameraSensor::Load(const std::string &_worldName, sdf::ElementPtr _sdf)
{
  Sensor::Load(_worldName, _sdf);
}

//////////////////////////////////////////////////
std::string FogCameraSensor::Topic() const
{
...
//////////////////////////////////////////////////
std::string FogCameraSensor::TopicIgn() const
{
...
//////////////////////////////////////////////////
void FogCameraSensor::Load(const std::string &_worldName)
{
...
//////////////////////////////////////////////////
void FogCameraSensor::Init()
{
  if (rendering::RenderEngine::Instance()->GetRenderPathType() ==
      rendering::RenderEngine::NONE)
  {
    gzerr << "Unable to create FogCameraSensor. Rendering is disabled.\n";
    return;
  }
  ...
  if (!worldName.empty())
  {
    ...
    if (!this->scene)
    {
      ...
      if (!this->scene)
      {
        gzerr << "Unable to create FogCameraSensor.\n";
        return;
      }
    }
    ...
    if (!this->camera)
    {
      gzerr << "Unable to create fog camera sensor[mono_camera]\n";
      return;
    }
...
//////////////////////////////////////////////////
bool FogCameraSensor::UpdateImpl(const bool /*_force*/)
{
...
//////////////////////////////////////////////////
unsigned int FogCameraSensor::ImageWidth() const
{
  if (this->camera)
    return this->camera->ImageWidth();

  if (this->sdf && this->sdf->HasElement("fog_camera"))
  {
    sdf::ElementPtr cameraSdf = this->sdf->GetElement("fog_camera");
...
//////////////////////////////////////////////////
unsigned int FogCameraSensor::ImageHeight() const
{
  if (this->camera)
...
//////////////////////////////////////////////////
const unsigned char *FogCameraSensor::ImageData() const
{
  if (this->camera)
...
//////////////////////////////////////////////////
bool FogCameraSensor::SaveFrame(const std::string &_filename)
{
  this->SetActive(true);
...
//////////////////////////////////////////////////
bool FogCameraSensor::IsActive() const
{
...
//////////////////////////////////////////////////
rendering::CameraPtr FogCameraSensor::Camera() const
{
  return this->camera;
}

//////////////////////////////////////////////////
bool FogCameraSensor::Rendered() const
{
  return this->dataPtr->rendered;
}

//////////////////////////////////////////////////
void FogCameraSensor::SetRendered(const bool _value)
{
