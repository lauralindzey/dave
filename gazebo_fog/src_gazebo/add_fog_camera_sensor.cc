...
extern void RegisterFogCameraSensor();

namespace gazebo {

class AddFogCameraSensor : public SystemPlugin {

    public: void Load(int _argc, char** _argv) {
        gzdbg <<"Adding FogCameraSensor" << std::endl;
        RegisterFogCameraSensor();
...
GZ_REGISTER_SYSTEM_PLUGIN(AddFogCameraSensor);
