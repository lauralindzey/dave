...
namespace gazebo
{
  namespace sensors
  {
    ...
    class FogCameraSensorPrivate;

    /// \addtogroup gazebo_sensors Sensors
    /// \{

    /// \class FogCameraSensor FogCameraSensor.hh sensors/sensors.hh
    /// \brief Basic camera sensor
    ///
    /// This sensor is used for simulating standard monocular cameras
    class GZ_SENSORS_VISIBLE FogCameraSensor : public Sensor
    {
      /// \brief Constructor
      public: FogCameraSensor();

      /// \brief Destructor
      public: virtual ~FogCameraSensor();
      ...
      private: std::unique_ptr<FogCameraSensorPrivate> dataPtr;
    };
    /// \}
  }
}
